...
pygame.time.set_timer(SPAWNPIPE, 1200)                  # after 1200 ms it will triger, using this to generate pipes after every 1200 ms
...
# bird and pipe are only visible when game_active is True. other things are visible always
    if game_active:
        ...
        pipe_list = move_pipes(pipe_list,move)
